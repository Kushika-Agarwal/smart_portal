...
//     setCaptchaUrl(
//       `http://localhost:5000/api/auth/captcha?${Date.now()}`
//     );
//   };
...
//         "http://localhost:5000/api/auth/verify-captcha",
...
//       <footer className="bg-white text-center text-sm text-gray-600 py-4 mt-20 border-t">
...
function AuthPage() {
  ...
  const generateCaptcha = () => {
    // setCaptchaUrl(`http://localhost:5000/api/auth/captcha?${Date.now()}`);
